...
if( roc )
  ...
  fprintf(1, '-------------------------------------------------------------------------------\n\n')
  idex = max(find(xs<0.1));
  fprintf(1, 'find index %d, %d;cooperate FPPI is %f, %f;cooperate score is %f, %f\n\n', idex, idex+1, xs(idex), xs(idex+1), score(idex), score(idex+1))
  fprintf(2, 'mean FPPI=0.1 score is: %f\n\n', (score(idex) + score(idex+1)) / 2)
  fprintf(1, '-------------------------------------------------------------------------------\n')
else
